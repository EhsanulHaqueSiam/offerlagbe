      ...
      <div className="flex items-center justify-between gap-2 p-2.5 sm:p-3 md:p-4">
        ...
        >
          ...
          <div className="hidden sm:block">
            <h1 className="text-sm font-bold text-white leading-none tracking-tight">OfferLagbe</h1>
        ...
        <div className="flex items-center gap-2 pointer-events-auto">
          ...
          >
            ...
            <span className="text-xs font-medium text-slate-300 hidden sm:inline">{t("lang.switch")}</span>
          </button>
          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M16 4h2a2 2 0 012 2v1a4 4 0 01-4 4h0M8 4H6a2 2 0 00-2 2v1a4 4 0 004 4h0M12 15v4m-4 0h8M9 4h6v7a3 3 0 11-6 0V4z"
              />
            </svg>
          </Link>
          ...
          >
            ...
            <span className="text-sm font-medium text-white hidden sm:inline">{t("header.addOffer")}</span>
          </Link>
        </div>
      </div>
    </header>
